<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddCourses.aspx.cs" Inherits="Online_Exam_Hub.Admin.AddCourses" %>
            ...
            <div class="col-md-7">
                <div class="card m-3">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <asp:TextBox ID="txtCourseID" runat="server" CssClass="form-control" Enabled="false" placeholder="Auto Increment ID" />
                                </div>
                        ...
                        <div class="mb-3">
                            <label for="<%=txtCourseDesc.ClientID %>"">Course Description:</label>
                            <asp:TextBox ID="txtCourseDesc" runat="server" CssClass="form-control" TextMode="MultiLine" />
                        </div>
